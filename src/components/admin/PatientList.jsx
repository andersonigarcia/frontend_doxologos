            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                    ...
                    <select
                        ...
                        className="w-full sm:w-48 px-4 py-2 bg-white border border-gray-200 rounded-xl font-semibold text-sm text-gray-700 focus:ring-2 focus:ring-emerald-500 cursor-pointer shadow-sm"
                    >
            ...
            <div className="flex flex-col gap-4">
                {paginatedPatients.map((patient, index) => (
                    <motion.div
                        ...
                        className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-5 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-all gap-4"
                    >
                        {/* Info Principal */}
                        ...
                        <div className="flex items-center gap-6 px-5 py-2.5 bg-gray-50 rounded-xl border border-gray-100">
                        ...
                        <div className="shrink-0 w-full sm:w-auto mt-2 sm:mt-0">
                            <Button
                                ...
                                className="w-full sm:w-auto bg-white border-gray-200 text-gray-700 hover:text-emerald-700 hover:bg-emerald-50 hover:border-emerald-200 rounded-xl font-semibold shadow-sm"
                            >
                                Ver Detalhes
                            </Button>
                        </div>
