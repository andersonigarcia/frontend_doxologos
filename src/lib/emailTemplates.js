...
<body>
  ...
  // EMAIL 10: Checklist de Saúde Mental
  checklistEmail(name) {
    const content = `
      <h2 style="color: #1f2937; font-size: 22px; margin: 0 0 10px 0;">Olá, ${this.sanitizeForHtml(name)}!</h2>
      <p style="font-size: 16px; color: #4b5563; margin: 0 0 25px 0;">
        Seu checklist de saúde mental chegou! Reconhecer que precisamos de ajuda é o primeiro passo para a transformação.
      </p>
      ...
      <p style="text-align: center; margin-top: 30px;">
        <a href="${this.baseUrl}/agendamento" class="btn">Agendar Consulta Agora</a>
      </p>
    ...
    `;
    return this.baseTemplate(content, "Checklist de Saúde Mental - Doxologos");
  }
