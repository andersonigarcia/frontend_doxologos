          ...
          {professionals.length === 0 ? (
            ...
            <motion.div ref={professionalsCarouselRef} className="flex overflow-x-auto space-x-8 pb-8 scroll-smooth carousel-container" style={{ scrollSnapType: 'x mandatory' }}>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="group relative bg-white border border-transparent hover:border-[#2d8659]/40 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 flex flex-col"
                style={{ scrollSnapAlign: 'start' }}
              >
